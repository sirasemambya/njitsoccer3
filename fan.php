...
<body>
	<div class="container-fluid">
		<?php navbar('plain',$filepath,'team2.php','');?>
	</div>
			...
			<div class="col-md-6 col-md-push-3">
				...
				<?php if((isset($submitschool) and !isset($duplicateschool)) or isset($_POST['accountsubmit'])) {?>
					...
					<div class="panel panel-primary shadow">
			  			...
			  			<div class="panel-body">
							<form class="form-horizontal" method="post" action="fan.php" id="signup-form">
								<fieldset>
				...
				<?php } else {?>
					...
					<div class="panel panel-primary shadow">
			  			...
			  			<div class="panel-body">
							<form id="schoolform" method="post" action="fan2.php">
								<fieldset>
									<div class="form-group">
										<div class="row">
